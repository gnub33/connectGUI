...
public class AboutDialog extends JDialog {
	...
	public AboutDialog(BoardView view) {
	...
	private JPanel createMainPanel() {
		...
		gbc.gridx = 0;
		gbc.gridy = 0;
		JLabel label = new JLabel("About ConnectN");
		...
		gbc.gridy++;
		String text = "I don't know who made this game "
				+ "but this was my implementation"
				+ "for CSCI304 Spring 2024";
		...
		gbc.gridx++;
		label = new JLabel("Daniel Knight (did not create original game)");
		label.setFont(textFont);
		panel.add(label, gbc);
		...
		gbc.gridx++;
		label = new JLabel("I submitted this in May 2024");
		label.setFont(textFont);
		panel.add(label, gbc);
